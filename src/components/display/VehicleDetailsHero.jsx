...
export default function VehicleDetailsHero({
  plateNumber,
  vehicleName,
  vehicleSub,
  type,
      ...
      <div className="grid grid-cols-1 gap-10 pr-20 md:grid-cols-3">
        <div className="space-y-8 mt-4">
          <Field label="Plate Number">
            <div className="text-3xl font-semibold tracking-tight">{plateNumber}</div>
          </Field>
        ...
        <div className="space-y-8 mt-26">
          <Field label="License No.">{ownerLicense}</Field>
        </div>
      </div>
